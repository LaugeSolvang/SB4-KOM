...
import collisionsystem.CollisionController;
...
public class Game
    ...
    public void create() {
        ...
        IPostEntityProcessingService collisionController = new CollisionController();
        postEntityProcessors.add(collisionController);
